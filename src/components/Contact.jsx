...
import DropletBackground from './DropletBackground.jsx' // ⬅️ фон-капля
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    alert('Спасибо за сообщение! Форма демонстрационная.')
  ...
  return (
    <section
      ...
      style={{ position: 'relative', overflow: 'hidden', background: '#000' }} // фон и слой для bg
    >
      {/* Фоновая 3D-капля позади текста */}
      <DropletBackground />
